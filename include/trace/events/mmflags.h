...
#define IF_HAVE_FCACHE_CTRL(flag,string) ,{1UL << flag, string}
#else
#define IF_HAVE_FCACHE_CTRL(flag,string)
#endif
...
IF_HAVE_FCACHE_CTRL(PG_vital,		"vital"		)		\
IF_HAVE_FCACHE_CTRL(PG_staple,		"staple"	)
